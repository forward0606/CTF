...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    */
    final int updateStatusGuard(WindowInsetsCompat insets, Rect rectInsets) {
        ...
        int systemWindowInsetTop5 = 0;
        if (insets != null) {
            systemWindowInsetTop5 = insets.getSystemWindowInsetTop();
        } else if (rectInsets != null) {
            systemWindowInsetTop5 = rectInsets.top;
        }
        boolean showStatusGuard = false;
        ActionBarContextView actionBarContextView = this.mActionModeView;
        if (actionBarContextView == null) {
            systemWindowInsetTop = systemWindowInsetTop5;
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (newTopMargin <= 0 || this.mStatusGuard != null) {
                    systemWindowInsetTop3 = systemWindowInsetTop5;
                ...
                boolean showStatusGuard2 = view4 != null;
                if (showStatusGuard2 && view4.getVisibility() != 0) {
                    updateStatusGuardColor(this.mStatusGuard);
                }
                if (!this.mOverlayActionMode && showStatusGuard2) {
                    systemWindowInsetTop4 = 0;
                } else {
                    systemWindowInsetTop4 = systemWindowInsetTop3;
                }
                showStatusGuard = showStatusGuard2;
                systemWindowInsetTop2 = systemWindowInsetTop4;
            } else {
                int systemWindowInsetTop6 = systemWindowInsetTop5;
                if (mlp.topMargin != 0) {
                    mlpChanged = true;
                    mlp.topMargin = 0;
                    systemWindowInsetTop2 = systemWindowInsetTop6;
                } else {
                    systemWindowInsetTop2 = systemWindowInsetTop6;
                }
            }
            ...
            return systemWindowInsetTop2;
        }
        systemWindowInsetTop2 = systemWindowInsetTop;
        view = this.mStatusGuard;
        if (view != null) {
        }
        return systemWindowInsetTop2;
