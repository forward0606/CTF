    ...
    */
    boolean scrollByInternal(int x, int y, MotionEvent ev) {
        ...
        if (this.mAdapter == null) {
            ...
            int consumedX2 = iArr2[0];
            int consumedY3 = iArr2[1];
            int unconsumedX2 = x - consumedX2;
            int unconsumedY2 = y - consumedY3;
        ...
        iArr3[0] = 0;
        iArr3[1] = 0;
        int consumedY4 = consumedY;
        int consumedX3 = consumedX;
        dispatchNestedScroll(consumedX, consumedY, unconsumedX, unconsumedY, this.mScrollOffset, 0, iArr3);
        int[] iArr4 = this.mReusableIntPair;
        int unconsumedX3 = unconsumedX - iArr4[0];
        int unconsumedY3 = unconsumedY - iArr4[1];
        boolean consumedNestedScroll = (iArr4[0] == 0 && iArr4[1] == 0) ? false : true;
        int i = this.mLastTouchX;
        int[] iArr5 = this.mScrollOffset;
        this.mLastTouchX = i - iArr5[0];
        ...
        if (consumedX3 == 0) {
            consumedY2 = consumedY4;
        } else {
            consumedY2 = consumedY4;
        }
        dispatchOnScrolled(consumedX3, consumedY2);
        if (!awakenScrollBars()) {
            invalidate();
        }
        return (!consumedNestedScroll && consumedX3 == 0 && consumedY2 == 0) ? false : true;
    }
    ...
    public void draw(Canvas c) {
        ...
        if (edgeEffect7 != null && !edgeEffect7.isFinished()) {
            ...
            needsInvalidate |= (edgeEffect8 == null || !edgeEffect8.draw(c)) ? false : false;
    ...
    */
    ...
    public final class Recycler {
        ...
        public ViewHolder tryGetViewHolderForPositionByDeadline(int position, boolean dryRun, long deadlineNs) {
            ...
            rvLayoutParams.mViewHolder = holder;
            rvLayoutParams.mPendingInvalidate = (fromScrapOrHiddenOrCache && bound) ? false : false;
            return holder;
        }
