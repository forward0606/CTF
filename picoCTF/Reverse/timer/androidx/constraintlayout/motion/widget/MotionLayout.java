                ...
                if (this.mBeginState == id2) {
                    ...
                    if (i2 == -1) {
                        ...
                        for (int i5 = 0; i5 < n; i5++) {
                            ...
                            controllers.put(v.getId(), this.mFrameArrayList.get(v));
                        }
                        this.mInTransition = true;
                        ...
                        if (this.mDecoratorsHelpers != null) {
                            ...
                            while (it.hasNext()) {
                                MotionHelper mDecoratorsHelper = it.next();
                                mDecoratorsHelper.onPreSetup(this, this.mFrameArrayList);
                            }
                            int i7 = 0;
                            while (i7 < n) {
                            ...
                            while (i8 < n) {
                                ...
                                if (motionController3 == null) {
                                    ...
                                    i3 = i8;
                                    motionController3.setup(layoutWidth, layoutHeight, this.mTransitionDuration, getNanoTime());
                                }
                                i8 = i3 + 1;
                            }
                        }
                        ...
                        if (stagger != 0.0f) {
                            ...
                            for (int i9 = 0; i9 < n; i9++) {
                                MotionController f = this.mFrameArrayList.get(getChildAt(i9));
                                float x = f.getFinalX();
                                float y = f.getFinalY();
                            ...
                            for (int i10 = 0; i10 < n; i10++) {
                                MotionController f2 = this.mFrameArrayList.get(getChildAt(i10));
