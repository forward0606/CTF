...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    */
    public ExtendedFloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context2, attrs, R.styleable.ExtendedFloatingActionButton, defStyleAttr, i, new int[0]);
        ...
        ChangeSizeStrategy changeSizeStrategy = new ChangeSizeStrategy(changeSizeTracker, new Size() { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.1
        ...
        ChangeSizeStrategy changeSizeStrategy2 = new ChangeSizeStrategy(changeSizeTracker, new Size() { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.2
            @Override // com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.Size
            public int getWidth() {
        ...
        a.recycle();
        ShapeAppearanceModel shapeAppearanceModel = ShapeAppearanceModel.builder(context2, attrs, defStyleAttr, i, ShapeAppearanceModel.PILL).build();
    ...
    protected static class ExtendedFloatingActionButtonBehavior<T extends ExtendedFloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        protected void shrinkOrHide(ExtendedFloatingActionButton fab) {
            ...
            MotionStrategy strategy = z ? fab.shrinkStrategy : fab.hideStrategy;
        ...
        protected void extendOrShow(ExtendedFloatingActionButton fab) {
            ...
            MotionStrategy strategy = z ? fab.extendStrategy : fab.showStrategy;
            fab.performMotion(strategy, callback);
        }
